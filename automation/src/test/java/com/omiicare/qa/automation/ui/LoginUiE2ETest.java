...
/**
 * UI end-to-end suite (Playwright) against the React SUT. Tagged {@code ui-e2e}:
 * excluded from the default build (it needs a running frontend and a downloaded
 * browser) and run with {@code -Pe2e}. Drives the app exclusively via the stable
 * {@code data-testid} selectors the frontend exposes.
 */
@Tag("ui-e2e")
